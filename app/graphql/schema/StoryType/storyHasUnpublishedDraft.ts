  ...
  ({ parent }) => {
    ...
    return !story.publicData
      ...
      : (
        ...
        || JSON.stringify(story.publicData.body) !== JSON.stringify(story.draftData.body)
        || JSON.stringify(story.publicData.coverImage) !== JSON.stringify(story.draftData.coverImage)
      )
  },
)
